	...
	for(int i = 0; i < n; i++){
            ...
            if(chic->Pt() >= onia::pTRange[rapBin-1][ptBin-1] &&
               ...
               TMath::Abs(chic->Rapidity()) < onia::rapForPTRange[rapBin]){
                ...
                // left sideband
                if(PolLSB){
                    if(chic->M() > massMinL && chic->M() < massMaxL && jpsict > PRmin && jpsict < PRmax){
                        outtree1->Fill();
                        outtree2->Fill();
                ...
                // right sideband
                    ...
                    if(chic->M() > massMinR && chic->M() < massMaxR && jpsict > PRmin && jpsict < PRmax){
                        outtree1->Fill();
                        outtree2->Fill();
                        pT_PSR1->Fill(chic->Pt());
                        rap_PSR1->Fill(TMath::Abs(chic->Rapidity()));
                ...
                // for non prompt data
                    ...
                    if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > NPmin && jpsict < NPmax){
                        outtree1->Fill();
                        pT_PSR1->Fill(chic->Pt());
                        rap_PSR1->Fill(TMath::Abs(chic->Rapidity()));
                    }
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2 && jpsict > NPmin && jpsict < NPmax){
                        outtree2->Fill();
                        pT_PSR2->Fill(chic->Pt());
                        rap_PSR2->Fill(TMath::Abs(chic->Rapidity()));
                    }
                ...
                //store only events from signal region
                    ...
                    if(chic->M() > massMinSR1 && chic->M() < massMaxSR1){
                        outtree1->Fill();
                        pT_PSR1->Fill(chic->Pt());
                        rap_PSR1->Fill(TMath::Abs(chic->Rapidity()));
                        MCevents1++;
                    }
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2){
                        outtree2->Fill();
                        pT_PSR2->Fill(chic->Pt());
                        rap_PSR2->Fill(TMath::Abs(chic->Rapidity()));
                        MCevents2++;
                    ...
                    if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > PRmin && jpsict < PRmax){
                        outtree1->Fill();
                        pT_PSR1->Fill(chic->Pt());
                        rap_PSR1->Fill(TMath::Abs(chic->Rapidity()));
                        count1++;
                    }
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2 && jpsict > PRmin && jpsict < PRmax){
                        outtree2->Fill();
                        pT_PSR2->Fill(chic->Pt());
                        rap_PSR2->Fill(TMath::Abs(chic->Rapidity()));
                        count2++;
                ...
                if(MC){
                    ...
                    else if(chic->M() > massMinL && chic->M() < massMaxL && jpsict > NPmin && jpsict < NPmax){
                        index = 1;
                    ...
                    else if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > PRmin && jpsict < PRmax){
                        index = 2;
                        hSR1_pTRapMass->Fill(chic->Pt(), TMath::Abs(chic->Rapidity()), funcSig1->GetRandom(massMinSR1, massMaxSR1));
                    }
                    else if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > NPmin && jpsict < NPmax){
                        index = 3;
                    ...
                    else if(chic->M() > massMinR && chic->M() < massMaxR && jpsict > PRmin && jpsict < PRmax){
                        index = 6;
                    ...
                    else if(chic->M() > massMinR && chic->M() < massMaxR && jpsict > NPmin && jpsict < NPmax){
                        index = 7;
	...
	for(int i = 0; i < n; i++){
            ...
            if(chic->Pt() >= onia::pTRange[rapBin-1][ptBin-1] &&
               ...
               TMath::Abs(chic->Rapidity()) < onia::rapForPTRange[rapBin]){
                ...
                if(!MC){
                    if(chic->M() > massMinL && chic->M() < massMaxL && jpsict > PRmin && jpsict < PRmax) index = 0;
                    else if(chic->M() > massMinL && chic->M() < massMaxL && jpsict > NPmin && jpsict < NPmax) index = 1;
                    else if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > PRmin && jpsict < PRmax) index = 2;
                    else if(chic->M() > massMinSR1 && chic->M() < massMaxSR1 && jpsict > NPmin && jpsict < NPmax) index = 3;
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2 && jpsict > PRmin && jpsict < PRmax) index = 4;
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2 && jpsict > NPmin && jpsict < NPmax) index = 5;
                    else if(chic->M() > massMinR && chic->M() < massMaxR && jpsict > PRmin && jpsict < PRmax) index = 6;
                    else if(chic->M() > massMinR && chic->M() < massMaxR && jpsict > NPmin && jpsict < NPmax) index = 7;
                    else continue;
                }
                else{
                    if(chic->M() > massMinSR1 && chic->M() < massMaxSR1) MCindex = 0;
                    else if(chic->M() > massMinSR2 && chic->M() < massMaxSR2) MCindex = 1;
                }
