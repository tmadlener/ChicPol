...
void polRec(double rapdilepton_min = 1,
  ...
  if(nEff > 10000 && nEff < 100000) hEvalEff = (TH2D*)hEvalEff2D->Clone("hEvalEff");
  else if(nEff > 100000){
  ...
  std::cout << "open data files" << std::endl;
  ...
  TLorentzVector* chic_gen = 0;    genData->SetBranchAddress( "chic",    &chic_gen );
  ...
  TLorentzVector* chic = new TLorentzVector(0.,0.,0.,0.);  data->Branch( "chic", "TLorentzVector", &chic );
