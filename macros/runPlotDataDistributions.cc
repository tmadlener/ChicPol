...
#include "PlotDataDistributions.cc"
...
int main(int argc, char* argv[]){
	...
	std::string arg = argv[i];
        ...
        fromSplit("PlottingDataDists", arg, PlottingDataDists);
      }
	...
	char infilenameData[200];
	sprintf(infilenameData,"tmpFiles/selEvents_data.root");

	PlotDataDistributions(infilename.c_str(), infilenameData, iRap, iPT, nState, PlottingDataDists);
      }
    }
    return 0;
}
